return {
  ...
  keys = {
    ...
    { "<leader>ctp",     ":split term://python3<cr>" },
  ...
  -- like ipython, R, bash
  {
    ...
    init = function()
      ...
      require("which-key").register({
        ...
        ["<leader>c"] = { "Coding Terminals" },
        ["<leader>cm"] = { mark_terminal, "Mark Terminal" },
        ["<leader>cs"] = { set_terminal, "Set terminal" },
        ["<leader>ct"] = { "Initiate Terminal" },
        ["<leader>ctr"] = { "R terminal" },
        -- ["<leader>cti"] = { "iPython terminal" },
        ["<leader>ctp"] = { "Python terminal" },
        ["<leader>ctj"] = { "Julia terminal" },
        ["<leader><CR>"] = { "Send Code" },
      })
    end,
  },
